...
export const AddTimeLineFormJSON = {
  ["form-slug"]: "AddTimeLine-form-FormJSON",
  formName: "ADD TIMELINE ",
  formPosition: "start",
  card: {
    style: {
      background: "#070707",
  ...
  Fields: [
    {
      initValue: "",
      validateField: Yup.string().required("NAME is Requird"),
      fieldType: FieldTypes.TEXT,
      label: "Timeline Name",
    ...
    {
      initValue: "",
      validateField: Yup.string().required("Image is Requird"),
    ...
    {
      initValue: "",
      validateField: Yup.string().required("desc is Requird"),
      fieldType: FieldTypes.TEXT,
      label: "DESC",
      placeholder: "DESC",
      name: "DESC",
