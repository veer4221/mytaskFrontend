...
import Typography from '@mui/material/Typography';
import DynamicForm from '../../../../../../../components/DynamicForm';
import { TimelineFormJSON } from '../../../../../../../FormGenrate/TimelineForm';
...
export default function PopUPFormTimeline({ setOpen, open }: any) {
        ...
        <div >
            ...
            >
                ...
                >
                    ...
                    <DynamicForm formData={TimelineFormJSON} isReRender={false} />
                </DialogContent>
